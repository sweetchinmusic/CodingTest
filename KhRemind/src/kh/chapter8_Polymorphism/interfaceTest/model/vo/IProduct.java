...
public interface IProduct {
	...
	double PI = 3.14; // 매번 쓰면 불편하니깐 // PI 가 static을 빼면 일어나야되는데 아직도 누워있음 // 앞에 public static final이 생략되어 있다.
	
	// 인터페이스의 메소드 선언하기 
	// 메소드 역시 public abstract를 붙이지 않으면
	// 자동으로 해당 예약어를 붙여준다.
	public abstract void testMethod2();
	void testMethod3();//미완성 메소드만 들어있음
