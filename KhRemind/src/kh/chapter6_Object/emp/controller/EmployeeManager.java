...
//		}
		...
		if(idx < 0) {
			...
			System.out.println("현재 사원 이름 : " + empArr[idx].getName());
			System.out.println("바꿀 사원 명 : ");
			empArr[idx].setName(sc.next());
		}
	}
...
//		}
		if(idx < 0) {
			...
			System.out.println("현재 사원의 나이 : " + empArr[idx].getAge());
			System.out.print("변경할 나이 : ");
			empArr[idx].setAge(sc.nextInt());
		}
	}
	public void updateEmpPhone() {
		...
		if(idx < 0) {
			...
			System.out.println("현재 사원의 연락처 : " + empArr[idx].getPhone());
			System.out.print("변경할 연락처 : ");
			empArr[idx].setPhone(sc.next());
		}
	}
	...
	public void printOneEmployee() {
		...
		if(idx < 0) {
			...
			System.out.println("조회 결과 : " + empArr[idx].empInfo());
		}
	}
